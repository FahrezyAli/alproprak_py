def main():
    ...
    print("Soal Nomor 2 Minggu 12 \"Sortir array paling belakang yang tidak terurut\"")
    ...
    while (a < 5):
        ...
        #Karena hanya x[4] yang tidak terurut, maka kita akan mengecek setiap nilai dalam array dengan x[4].
        if (x[a] > x[4]):
